const STRINGS = {
  russian: {
    ...
    titleWishes: "Ваши пожелания - Свадьба Пэйпэй и Андрея",
    ...
    wishesTitle: "Ваши тёплые слова",
    wishesDescription: "Самый ценный подарок для нас — это ваше внимание и присутствие. Но если вы хотите оставить нам тёплое послание или напутствие в этот особенный день, мы будем этому очень рады. Ваши слова станут важной частью нашей семейной истории.",
  ...
  mandarin: {
    ...
    titleWishes: "祝福留言 - 珮珮和安德烈的婚禮",
    title404: "404 - 珮珮和安德烈的婚禮",
    titleGallery: "相簿 - 珮珮和安德烈的婚禮",
    titleImaginarium: "想像世界 - 珮珮和安德烈的婚禮",
    ...
    wishesTitle: "您的祝福與叮嚀",
    wishesDescription: "您的蒞臨是對我們最大的祝福。如果您願意寫下幾句溫暖的話語或對未來的期許，我們將萬分感激。這些珍貴的文字將被我們永久珍藏，陪伴我們開啟人生的新篇章。",
